namespace lambdaDz
{
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Тест 1: " + string.Join(", ", getUniqueNegatives(testArray1)));
            Console.WriteLine("Тест 2: " + string.Join(", ", getUniqueNegatives(testArray2)));
            Console.WriteLine("Тест 3: " + string.Join(", ", getUniqueNegatives(testArray3)));
            Console.WriteLine("Тест 4: " + string.Join(", ", getUniqueNegatives(testArray4)));
            Console.WriteLine("Тест 5: " + string.Join(", ", getUniqueNegatives(testArray5)));

            // task 6
            string text = "Привіт світ! Світ великий і прекрасний";
            string searchWord = "світ";
            ...
            Console.WriteLine($"Слово '{searchWord}' зустрічається {occurrences} раз(и) у тексті.");

            // task 7
            Func<int, bool> validatePin = pin => pin == 1234;

            Action<decimal> displayBalance = balance => Console.WriteLine($"Ваш баланс: {balance} грн");
